...
Purpose: Implements ColdFusion front-end image upload functionality with jQuery Cropper plugin from http://fengyuanchen.github.io/cropper/.
 --->
...
<head>
    ...
    <style type="text/css">
        ...
        .temp_label_red{color:red;}
        .temp_label_green{color:green;}
        .temp_label_blue{color:blue;}
        .temp_label_default{color:#A6B6C2;}
        .temp_modal{text-align:center;}
        .temp_modal_red{color:red;}
        .temp_modal_default{color:#A6B6C2;}
        
        
        /*Drop Zone and Image Upload Area*/
        .dz_container_normal{border:2px dashed #dee3e7;border-radius:3px;}/*#dee3e7*/
        .dz_container_over  {border:2px dashed rgba(102, 102, 102, 0.69);}/*rgba(102, 102, 102, 0.69)*/
        .dz_normal{background-color:rgba(229, 229, 229, 0.30);transition:background-color 300ms ease,border 300ms ease;}
        .dz_over  {background-color:rgba(229, 229, 229, 0.75);transition:background-color 300ms ease,border 300ms ease;}
        #drop_zone_container       {width:216px;height:346px;}
        #drop_zone_container:hover {border:2px dashed rgba(102, 102, 102, 0.69);}

        /*custom upload button*/
        .input_select_image           {display:none;}
        ...
        .profile_img img:first-child {border:1px solid rgba(197, 201, 205, 0.3);}

        #image_drop_zone        {text-align:center;color:#A6B6C2/;font:bold normal 18px Arial,"Helvetica Neue",Helvetica,sans-serif;width:200px;height:300px;}
        #image_drop_zone:hover  {color:rgba(102, 102, 102, 0.69);background-color:rgba(229, 229, 229, 0.75);transition:background-color 300ms ease,border 300ms ease;}
        ...
        .on_successful_image_upload{border:2px dashed green;
        /*
                        ...
                        <div id="file_select_container" style="margin-top:4px;border:0px solid red;width:200px;">
                            <div id="upload_icon_div_2" class="modern_button">
                                ...
                                <label for="input_manual_select" style="width:100%;height:100%;">        
                                    ...
                                    <span id='label_manual_select'>Select an image</span>
                                </label>
